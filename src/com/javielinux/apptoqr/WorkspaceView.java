...
public class WorkspaceView extends ViewGroup {
	...
	private int tabFontColor = 0xFF000000;
	private int selectedTabFontColor = 0xFF000000;
	...
	/**
	 * Configura los tabs de navegaci—n para que se autoseleccionen al cambiar de pantalla
	 * 
	 * 100% opcional.
	 * 
	 * @param linear
	 ...
	 * @param tabTitles
	 */
	public void configTabs(LinearLayout linear, int tabDrawable, int selectedTabDrawable, int tabFontColor, int selectedTabFontColor, String[] tabTitles) {
	...
	public void relocate() {
		//No parece que funcione del todo bien. Habr‡ que buscar una soluci—n.
		scrollToScreen(currentScreen);
		getChildAt(currentScreen).requestFocus();
	}
	...
	private void snapToDestination() {
		...
		Log.d(TAG, "snapToDestination :: SW:" + screenWidth + ", WS:" + whichScreen);
	...
	public void scrollToScreen(int whichScreen) {
		...
		//Log.d(TAG, "newX=" + newX + " scrollX=" + getScrollX() + " delta=" + delta + " abs=" + (Math.abs(delta) * 2));
